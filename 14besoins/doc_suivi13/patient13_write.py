...
from need_upload.upload13 import needuploadata
...
def suiteBackup():
    ...
    """
    with open('./14besoins/doc_suivi13/patient13_14b.txt', 'w') as namefile:
...
try:
    if os.path.getsize('./14besoins/doc_suivi13/patient13_14b.txt'):
        importationFile('./14besoins/doc_suivi13/patient13_14b.txt',
            encodage='Utf-8')
