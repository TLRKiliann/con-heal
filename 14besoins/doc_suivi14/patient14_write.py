...
from need_upload.upload14 import needuploadata
...
def suiteBackup():
    ...
    """
    with open('./14besoins/doc_suivi14/patient14_14b.txt', 'w') as namefile:
...
try:
    if os.path.getsize('./14besoins/doc_suivi14/patient14_14b.txt'):
        importationFile('./14besoins/doc_suivi14/patient14_14b.txt',
            encodage='Utf-8')
