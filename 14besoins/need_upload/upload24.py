...
def process_unknown_duration(root):
    time.sleep(1)
    proc = subprocess.run(["scp", "./14besoins/doc_suivi24/main_14b.txt",
    ...
    secproc = subprocess.run(["scp", "./14besoins/doc_suivi24/patient24_14b.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt1/Files1/patient24_14b.txt"],
        stderr=subprocess.PIPE)
