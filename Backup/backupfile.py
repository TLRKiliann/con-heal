                ...
                if time.strftime("%d/%m/%Y") == x:
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed/resultvmed.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed/resultvmed.txt', './Backup/Files1/Backup_resultvmed.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed2/resultvmed2.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed2/resultvmed2.txt', './Backup/Files2/Backup_resultvmed2.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed3/resultvmed3.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed3/resultvmed3.txt', './Backup/Files3/Backup_resultvmed3.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed4/resultvmed4.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed4/resultvmed4.txt', './Backup/Files4/Backup_resultvmed4.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed5/resultvmed5.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed5/resultvmed5.txt', './Backup/Files5/Backup_resultvmed5.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed6/resultvmed6.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed6/resultvmed6.txt', './Backup/Files6/Backup_resultvmed6.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed7/resultvmed7.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed7/resultvmed7.txt', './Backup/Files7/Backup_resultvmed7.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed8/resultvmed8.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed8/resultvmed8.txt', './Backup/Files8/Backup_resultvmed8.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed9/resultvmed9.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed9/resultvmed9.txt', './Backup/Files9/Backup_resultvmed9.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed10/resultvmed10.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed10/resultvmed10.txt', './Backup/Files10/Backup_resultvmed10.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed11/resultvmed11.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed11/resultvmed11.txt', './Backup/Files11/Backup_resultvmed11.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed12/resultvmed12.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed12/resultvmed12.txt', './Backup/Files12/Backup_resultvmed12.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed13/resultvmed13.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed13/resultvmed13.txt', './Backup/Files13/Backup_resultvmed13.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed14/resultvmed14.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed14/resultvmed14.txt', './Backup/Files14/Backup_resultvmed14.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed15/resultvmed15.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed15/resultvmed15.txt', './Backup/Files15/Backup_resultvmed15.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed16/resultvmed16.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed16/resultvmed16.txt', './Backup/Files16/Backup_resultvmed16.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed17/resultvmed17.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed17/resultvmed17.txt', './Backup/Files17/Backup_resultvmed17.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed18/resultvmed18.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed18/resultvmed18.txt', './Backup/Files18/Backup_resultvmed18.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed19/resultvmed19.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed19/resultvmed19.txt', './Backup/Files19/Backup_resultvmed19.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed20/resultvmed20.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed20/resultvmed20.txt', './Backup/Files20/Backup_resultvmed20.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed21/resultvmed21.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed21/resultvmed21.txt', './Backup/Files21/Backup_resultvmed21.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed22/resultvmed22.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed22/resultvmed22.txt', './Backup/Files22/Backup_resultvmed22.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed23/resultvmed23.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed23/resultvmed23.txt', './Backup/Files23/Backup_resultvmed23.txt')
                    ...
                    try:
                        if os.path.exists('./vmed/doc_vmed24/resultvmed24.txt'):
                            ...
                            shutil.copy('./vmed/doc_vmed24/resultvmed24.txt', './Backup/Files24/Backup_resultvmed24.txt')
