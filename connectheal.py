...
class ConnectorDB:
    def __init__(self, root):
        ...
        #self.can = Canvas(self.master, width=1250, height=800, bg='grey18')
        ...
        # Interact with database to display data
        def DisplayData():
            sqlCon = pymysql.connect(host='127.0.0.1', user='root', password='Ko@l@tr3379', database='timetrackconn')
            cur = sqlCon.cursor()
        ...
        # Interact with database to display data from database in frame
        ...
        # Interact with database to delete data
        def deleteDB():
            sqlCon = pymysql.connect(host='127.0.0.1', user='root', password='Ko@l@tr3379', database='timetrackconn')
            cur = sqlCon.cursor()
