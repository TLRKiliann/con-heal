...
def Window(self):
    ...
    def allInData():
        ...
        self.txtBox.insert('2.0', line2 + "\n\n")
        self.txtBox.insert('4.0', native + "\n\n")
        self.txtBox.insert('6.0', phone + "\n\n")
        self.txtBox.insert('8.0', street + "\n\n")
        self.txtBox.insert('9.0', state + "\n\n")
        self.txtBox.insert('11.0', email + "\n\n")
        self.txtBox.insert('13.0', assu + "\n\n")
        self.txtBox.insert('15.0', polins + "\n\n")
    ...
    def recorderData(namentry, birthentry, native, nativaentry, txtphone, phonentry,
        ...
        try:
            with open('./contact/contact1.txt', 'w') as iofile:
                ...
                self.txtBox.insert('4.0', "Native : " + nativaentry.get() + "\n\n")
                iofile.write("Phone : " + phonentry.get() + "\n")
                self.txtBox.insert('6.0', "Phone : " + phonentry.get() + "\n\n")
                iofile.write("Address : " + addrentry.get() + "\n")
                self.txtBox.insert('8.0', "Address : " + addrentry.get() + "\n\n")
                iofile.write("City : " + cityentry.get() + "\n")
                self.txtBox.insert('9.0', "City : " + cityentry.get() + "\n\n")
                iofile.write("e-mail : " + entrymail.get() + "\n")
                self.txtBox.insert('11.0', "e-mail : " + entrymail.get() + "\n\n")
                iofile.write("Insurance : " + entryassu.get() + "\n")
                self.txtBox.insert('13.0', "Insurance : " + entryassu.get() + "\n\n")
                iofile.write("Policy : " + entrypolicy.get() + "\n")
                self.txtBox.insert('15.0', "Policy : " + entrypolicy.get() + "\n\n")
