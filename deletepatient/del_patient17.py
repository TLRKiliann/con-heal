...
def delFuncFile17():
    ...
    backproc = subprocess.run(["scp", "-r", "./Backup/Files17",
    ...
    if delproc.stderr == b'':
        print("+ Files17 has been deleted on server !")
    ...
    try:
        if os.path.getsize('./param/paramdata17.txt'):
            ...
            print("+ File paramdata17.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed17/resultvmed17.txt'):
            ...
            print("+ File resultvmed17.txt deleted")
