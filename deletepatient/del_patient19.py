...
def delFuncFile19():
    ...
    if delproc.stderr == b'':
        print("+ Files19 has been deleted on server !")
    ...
    try:
        if os.path.getsize('./param/paramdata19.txt'):
            ...
            print("+ File paramdata19.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed19/resultvmed19.txt'):
            ...
            print("+ File resultvmed19.txt deleted")
