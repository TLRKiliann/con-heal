...
def delFuncFile23():
    ...
    if delproc.stderr == b'':
        print("+ Files23 has been deleted on server !")
    ...
    try:
        if os.path.getsize('./param/paramdata23.txt'):
            ...
            print("+ File paramdata23.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed23/resultvmed23.txt'):
            ...
            print("+ File resultvmed23.txt deleted")
