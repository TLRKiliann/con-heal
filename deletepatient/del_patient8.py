...
def delFuncFile8():
    ...
    if delproc.stderr == b'':
        print("+ Files8 has been deleted on server !")
    ...
    try:
        if os.path.getsize('./param/paramdata8.txt'):
            ...
            print("+ File paramdata8.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed8/resultvmed8.txt'):
            ...
            print("+ File resultvmed8.txt deleted")
