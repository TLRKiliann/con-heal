...
def delFuncFile9():
    ...
    if delproc.stderr == b'':
        print("+ Files9 has been deleted on server !")
    ...
    try:
        if os.path.getsize('./param/paramdata9.txt'):
            ...
            print("+ File paramdata9.txt deleted")
