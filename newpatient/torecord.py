...
def get(PatientID, patientnum, Firstname, labelfirst, Surname, lblsurname, 
    Birthvalue, Birth_entree, Allergia, Patient_allergy, Diagnosis, Diagnos_pat):
    """
        Add a patient with
        the add button
    """
        ...
        if os.path.getsize('./newpatient/entryfile.txt'):
            with open('./newpatient/entryfile.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot in line:
                        searchLine1(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile2.txt'):
            with open('./newpatient/entryfile2.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot2 in line:
                        searchLine2(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile3.txt'):
            with open('./newpatient/entryfile3.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot3 in line:
                        searchLine3(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile4.txt'):
            with open('./newpatient/entryfile4.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot4 in line:
                        searchLine4(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile5.txt'):
            with open('./newpatient/entryfile5.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot5 in line:
                        searchLine5(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile6.txt'):
            with open('./newpatient/entryfile6.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot6 in line:
                        searchLine6(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile7.txt'):
            with open('./newpatient/entryfile7.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot7 in line:
                        searchLine7(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile8.txt'):
            with open('./newpatient/entryfile8.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot8 in line:
                        searchLine8(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile9.txt'):
            with open('./newpatient/entryfile9.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot9 in line:
                        searchLine9(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile10.txt'):
            with open('./newpatient/entryfile10.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot10 in line:
                        searchLine10(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile11.txt'):
            with open('./newpatient/entryfile11.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot11 in line:
                        searchLine11(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile12.txt'):
            with open('./newpatient/entryfile12.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot12 in line:
                        searchLine12(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile13.txt'):
            with open('./newpatient/entryfile13.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot13 in line:
                        searchLine13(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile14.txt'):
            with open('./newpatient/entryfile14.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot14 in line:
                        searchLine14(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile15.txt'):
            with open('./newpatient/entryfile15.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot15 in line:
                        searchLine15(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile16.txt'):
            with open('./newpatient/entryfile16.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot16 in line:
                        searchLine16(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile17.txt'):
            with open('./newpatient/entryfile17.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot17 in line:
                        searchLine17(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile18.txt'):
            with open('./newpatient/entryfile18.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot18 in line:
                        searchLine18(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile19.txt'):
            with open('./newpatient/entryfile19.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot19 in line:
                        searchLine19(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile20.txt'):
            with open('./newpatient/entryfile20.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot20 in line:
                        searchLine20(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile21.txt'):
            with open('./newpatient/entryfile21.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot21 in line:
                        searchLine21(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile22.txt'):
            with open('./newpatient/entryfile22.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot22 in line:
                        searchLine22(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile23.txt'):
            with open('./newpatient/entryfile23.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot23 in line:
                        searchLine23(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        pass
        ...
        if os.path.getsize('./newpatient/entryfile24.txt'):
            with open('./newpatient/entryfile24.txt', 'r') as file:
                ...
                for i in range(0, len(lines)):
                    line = lines[i]
                    if mot24 in line:
                        searchLine24(Firstname, Surname, Birthvalue, Allergia, Diagnosis)
    else:
        print("There is no file to edit as entryfile")

    gui.destroy()

def searchLine1(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
    """
...
def searchLine2(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine3(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine4(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine5(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine6(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine7(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine8(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine9(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine10(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine11(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine12(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine13(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine14(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine15(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine16(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine17(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine18(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine19(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine20(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine21(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine22(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine23(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
...
def searchLine24(Firstname, Surname, Birthvalue, Allergia, Diagnosis):
