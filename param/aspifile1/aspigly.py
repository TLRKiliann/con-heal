...
file = open('./param/aspifile/gly.json')
data = json.load(file)
#file.close
...
with open('./param/aspifile/data_dategly.json', 'a+') as datafile:
...
with open('./param/aspifile/data_gly.json', 'a+') as datafile:
    json.dump(data_list2, datafile, indent=4)

print("\nDownloading 'plot_prog.py'...")

subprocess.call('./param/aspifile/plot/plot_gly.py')
