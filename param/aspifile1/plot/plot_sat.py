...
print("\nListe1 = dates :")
print("--------------")
fileO = open('./param/aspifile/data_datesat.json')
...
fileO = open('./param/aspifile/data_sat.json')
...
os.remove('./param/aspifile/data_datesat.json')
print("+ File data_datesat.json removed !")
os.remove('./param/aspifile/data_sat.json')
