...
def writeData():
    ...
    try:
        if os.path.getsize('./param/aspifile10/tensor.json'):
            print("+ File 'tensor' exist !")
            with open('./param/aspifile10/tensor.json', 'r') as datafile:
            ...
            if textTa.get() == "":
                ...
                with open('./param/aspifile10/tensor.json', 'w') as datafile2:
        ...
        if textTa.get() == "":
            ...
            print("---Ok VALEUR 'Tension' entrée---")
            with open('./param/aspifile10/tensor.json', 'w') as datafile:
...
def delTA():
    ...
    try:
        if os.path.getsize('./param/aspifile10/tensor.json'):
            with open('./param/aspifile10/tensor.json', 'r') as file:
                data = json.load(file)
            for key, value in data.items():
                print("Last value of TA deleted")
                print(value[-1])
                del value[-1]
            with open('./param/aspifile10/tensor.json', 'w') as file:
