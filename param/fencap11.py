...
try:
    proc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt11/paramdata11.txt",
        "./param/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    secproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt11/diastol.json",
        "./param/aspifile11/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(secproc.stderr))
    thirdproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt11/dlr.json",
        "./param/aspifile11/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(thirdproc.stderr))
    forthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt11/freq.json",
        "./param/aspifile11/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(forthproc.stderr))
    fivthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt11/gly.json",
        "./param/aspifile11/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(fivthproc.stderr))
    sixthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt11/puls.json",
        "./param/aspifile11/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(sixthproc.stderr))
    sevenproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt11/sat.json",
        "./param/aspifile11/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(sevenproc.stderr))
    eightproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt11/systol.json",
        "./param/aspifile11/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(eightproc.stderr))
    ninethproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt11/temp.json",
        "./param/aspifile11/"], stderr=subprocess.PIPE)
...
def writeData(textDate, textHour, textName, textTa, textDia,
    ...
    try:
        ...
        print("The file : 'paramdata11.txt' doesn't exist !", info)
    ...
    if Main_MsgBox == 'yes':
        try:
            if os.path.getsize('./param/paramdata11.txt'):
                ...
                print("+ File paramdata11.txt has been deleted !")
