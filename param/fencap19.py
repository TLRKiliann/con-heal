...
try:
    proc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt19/paramdata19.txt",
        "./param/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    secproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt19/diastol.json",
        "./param/aspifile19/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(secproc.stderr))
    thirdproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt19/dlr.json",
        "./param/aspifile19/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(thirdproc.stderr))
    forthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt19/freq.json",
        "./param/aspifile19/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(forthproc.stderr))
    fivthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt19/gly.json",
        "./param/aspifile19/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(fivthproc.stderr))
    sixthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt19/puls.json",
        "./param/aspifile19/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(sixthproc.stderr))
    sevenproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt19/sat.json",
        "./param/aspifile19/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(sevenproc.stderr))
    eightproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt19/systol.json",
        "./param/aspifile19/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(eightproc.stderr))
    ninethproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt19/temp.json",
        "./param/aspifile19/"], stderr=subprocess.PIPE)
...
def writeData(textDate, textHour, textName, textTa, textDia,
    ...
    try:
        ...
        print("The file : 'paramdata19.txt' doesn't exist !", info)
    ...
    if Main_MsgBox == 'yes':
        try:
            if os.path.getsize('./param/paramdata19.txt'):
                ...
                print("+ File paramdata19.txt has been deleted !")
