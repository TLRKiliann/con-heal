...
try:
    proc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/paramdata23.txt",
        "./param/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    secproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/diastol.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(secproc.stderr))
    thirdproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/dlr.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(thirdproc.stderr))
    forthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/freq.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(forthproc.stderr))
    fivthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/gly.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(fivthproc.stderr))
    sixthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/puls.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(sixthproc.stderr))
    sevenproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/sat.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(sevenproc.stderr))
    eightproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/systol.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(eightproc.stderr))
    ninethproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/temp.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
...
def writeData(textDate, textHour, textName, textTa, textDia,
    ...
    try:
        ...
        print("The file : 'paramdata23.txt' doesn't exist !", info)
    ...
    if Main_MsgBox == 'yes':
        try:
            if os.path.getsize('./param/paramdata23.txt'):
                ...
                print("+ File paramdata23.txt has been deleted !")
