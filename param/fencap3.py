...
import subprocess
import time
from progresstask3 import Main
...
try:
    proc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt3/paramdata3.txt",
        "./param/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    secproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt3/diastol.json",
        "./param/aspifile3/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(secproc.stderr))
    thirdproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt3/dlr.json",
        "./param/aspifile3/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(thirdproc.stderr))
    forthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt3/freq.json",
        "./param/aspifile3/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(forthproc.stderr))
    fivthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt3/gly.json",
        "./param/aspifile3/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(fivthproc.stderr))
    sixthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt3/puls.json",
        "./param/aspifile3/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(sixthproc.stderr))
    sevenproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt3/sat.json",
        "./param/aspifile3/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(sevenproc.stderr))
    eightproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt3/systol.json",
        "./param/aspifile3/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(eightproc.stderr))
    ninethproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt3/temp.json",
        "./param/aspifile3/"], stderr=subprocess.PIPE)
...
def writeData(textDate, textHour, textName, textTa, textDia,
    ...
    try:
        ...
        print("The file : 'paramdata3.txt' doesn't exist !", info)
    ...
    if Main_MsgBox == 'yes':
        try:
            if os.path.getsize('./param/paramdata3.txt'):
                ...
                print("+ File paramdata3.txt has been deleted !")
