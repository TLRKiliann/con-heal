...
def callTreatment11(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt11/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt11/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt11/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt11/convres.json",
