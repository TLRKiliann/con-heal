...
def callTreatment12(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt12/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt12/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt12/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt12/convres.json",
