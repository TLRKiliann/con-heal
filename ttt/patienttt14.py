...
def callTreatment14(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt14/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt14/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt14/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt14/convres.json",
