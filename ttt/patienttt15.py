...
def callTreatment15(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt15/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt15/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt15/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt15/convres.json",
