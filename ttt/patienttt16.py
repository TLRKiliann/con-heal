...
def callTreatment16(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt16/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt16/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt16/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt16/convres.json",
