...
def callTreatment17(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt17/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt17/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt17/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt17/convres.json",
