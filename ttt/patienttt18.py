...
def callTreatment18(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt18/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt18/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt18/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt18/convres.json",
