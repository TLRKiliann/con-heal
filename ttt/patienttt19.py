...
def callTreatment19(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt19/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt19/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt19/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt19/convres.json",
