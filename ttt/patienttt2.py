...
def callTreatment2(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt2/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt2/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt2/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt2/convres.json",
