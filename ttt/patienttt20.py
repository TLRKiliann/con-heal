...
def callTreatment20(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt20/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt20/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt20/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt20/convres.json",
