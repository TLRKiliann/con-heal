...
def callTreatment21(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt21/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt21/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt21/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt21/convres.json",
