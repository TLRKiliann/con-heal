...
def callTreatment22(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt22/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt22/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt22/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt22/convres.json",
