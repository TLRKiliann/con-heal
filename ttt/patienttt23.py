...
def callTreatment23(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt23/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt23/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt23/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt23/convres.json",
