...
def callTreatment24(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt24/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt24/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt24/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt24/convres.json",
