...
def callTreatment3(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt3/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt3/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt3/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt3/convres.json",
