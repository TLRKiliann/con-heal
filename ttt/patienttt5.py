...
def callTreatment5(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt5/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt5/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt5/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt5/convres.json",
