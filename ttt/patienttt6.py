...
def callTreatment6(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt6/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt6/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt6/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt6/convres.json",
