...
def callTreatment8(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt8/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt8/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt8/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt8/convres.json",
