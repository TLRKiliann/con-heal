...
def callTreatment9(self):
    ...
    def tttupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt9/intro_ttt.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt9/convdose.json",
    ...
    def resupload():
        ...
        """
        proc = subprocess.run(["scp", "./ttt/doc_ttt9/intro_res.txt",
        ...
        secproc = subprocess.run(["scp", "./ttt/doc_ttt9/convres.json",
