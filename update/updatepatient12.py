    ...
    try:
        if os.path.getsize('./diag/doc_diag12/diagrecap12.txt'):
            ...
            messagebox.showinfo("Info", "Data was updated for entryfile12.txt, " \
                "allergyfile12.txt, diagrecap12.txt !")
    except FileNotFoundError as not_ffile:
        print("- diagrecap12.txt not found, plz create file clicking on diagnostic -")
        print(str(not_ffile))
...
def searchLineName12(firstpat, surname, birthvalue,
    allergia, transdisval, diagnosis):
    """
